...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    protected int[] itemdrawables = { R.drawable.ease_chat_takepic_selector, R.drawable.ease_chat_image_selector,
            R.drawable.ease_chat_location_selector ,R.drawable.voice,R.drawable.vedio,};
    protected int[] itemIds = { ITEM_TAKE_PICTURE, ITEM_PICTURE, ITEM_LOCATION ,ITEM_VOICE,ITEM_VEDIO};
...
//        }
        ...
        titleBar.setBackgroundColor(getResources().getColor(R.color.bg));
    }
